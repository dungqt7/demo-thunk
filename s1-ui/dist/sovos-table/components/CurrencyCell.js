...
function (_PureComponent) {
  _inherits(CurrencyCell, _PureComponent);

  function CurrencyCell() {
    _classCallCheck(this, CurrencyCell);

    return _possibleConstructorReturn(this, _getPrototypeOf(CurrencyCell).apply(this, arguments));
  }

  _createClass(CurrencyCell, [{
    key: "render",
    value: function render() {
      ...
      return _react.default.createElement("div", {
        ...
        style: styles
      }, this.props.formatCurrency(this.props.value));
    }
  }]);
...
CurrencyCell.propTypes = process.env.NODE_ENV !== "production" ? {
